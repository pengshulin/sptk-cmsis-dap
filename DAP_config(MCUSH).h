...
{
    GPIOA->CRL = GPIOA->CRL & ~(0xF<<0) | (0x1<<0);
}
...
static __inline void DAP_SETUP (void)
{
    ...
    // PB[8:11], LED-USB,输出模式，输出低电平，熄灭
    GPIOB->CRH   &= ~0x0000FFFF;
    GPIOB->CRH   |=  0x00001111;
    GPIOB->BRR = 0x0F00;
